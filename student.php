        ...
        <div class="page-wrapper">
           <?php 
                        ...
                        switch($source) {
                            ...
                            break;
                            case 'student_list';
                            include"./includes/all_student.php";
                            break;
                            case 'student_profil';
             ...
             ?>
                        ...
                        if(isset($_POST['add_student'])){
                            ...
                            $student->student_branch = $_POST['branch'];
                            $student->student_level = $_POST['level'];
                            $notify->notify_date = date('d-m-y');
                            $notify->notify_title = "New Student are Added";
                            $notify->notify_txt = $student->student_name." are Added to the Database";
