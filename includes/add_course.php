                ...
                <div class="row">
                    ...
                    <form method="POST">
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="subject_name">Subject code <span class="text-danger">*</span></label>
                                ...
                                <div class="col-sm-6 col-md-6 col-lg-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="subject_branch" value="<?php echo $branch_select;?>">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-6 col-lg-2">
                                    <div class="form-group">
                                        <label for="branch_level">level</label>
                                        <input type="text" class="form-control" name="branch_level" value="<?php echo $level_select;?>">
                                    </div>
                                </div>
                                <div class="col-sm-6 col-md-6 col-lg-5">
                                    <div class="form-group">
                                    <label for="image">Course_pdf</label>
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn" name="add_subject">Save</button>
                            </div>
                        </form>
                    </div>
                </div>
