    ...
    <div class="main-wrapper">
        ...
        <?php 
                        ...
                        switch($source) {
                            ...
                            break;
                            case 'subject_list';
                            include"./includes/all_subject.php";
                            break;
                            default:
            ...
            if(isset($_POST['add_subject'])){
                ...
                $branch_level = $_POST['branch_level'];
                $semester = $_POST['semester'];
                $teacher = $_POST['teacher'];
                $obj->saveRecords($subject_name, $subject_credit, $subject_title, $subject_branch, $branch_level, $semester, $teacher);              
            }
